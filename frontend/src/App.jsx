        ...
        >
          ...
          <div className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            <div className="flex items-center justify-between">
              <Link to={"/"} className="-m-1.5 p-1.5">
                <span className="sr-only">Your Company</span>
                <img className="h-50  w-auto" src="/logo.png" alt="" />
              </Link>
              <button
                type="button"
      ...
      <footer>
        <div className="mx-auto max-w-7xl mb-16 px-6 md:px-20 grid grid-cols-1 md:grid-cols-4 gap-3">
          <div>
            ...
            <p className="text-violet-800 md:text-sm font-bold">
              Crafted with &#10083; from MAHI
            </p>
          </div>
          <div></div>
          <div></div>
        ...
        <p className="text-center py-1 bg-gray-200 text-gray-500 text-sm">
          Copyright © 2024 EarthKind. | All Rights Reserved
        </p>
      </footer>
    </div>
  );
